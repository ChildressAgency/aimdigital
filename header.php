...
<body>
    ...
    <div class="container">
      ...
      <?php
        $header_nav_args = array(
          ...
          'menu_id' => '',
          'echo' => true,
          'fallback_cb' => 'aimdigital_header_fallback_menu',
  ...
  <?php if(is_front_page()): ?>
    <?php if(get_field('hero_type') == 'video'): ?>
      <div id="hero" class="hp-hero embed-responsive embed-responsive-16by9">
        <video controls autoplay loop>
          <source src="<?php the_field('hero_video'); ?>" type="video/mp4" />
        </video>
    <?php else: ?>
      <div id="hero" class="hp-hero" style="background-image:url(<?php the_field('hero_image'); ?>); <?php the_field('hero_image_css'); ?>">
    <?php endif; ?>
